...
int main()
{
    ...
    background = LoadImage("/home/mi/workspace/code/PhoenixSimulator/Simulator/test/resource/background.bmp");
    image = LoadImage("/home/mi/workspace/code/PhoenixSimulator/Simulator/test/resource/image.bmp");
